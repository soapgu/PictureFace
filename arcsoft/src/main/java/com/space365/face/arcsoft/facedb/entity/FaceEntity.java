package com.space365.face.arcsoft.facedb.entity;
...
public class FaceEntity implements Parcelable {
    ...
    public FaceEntity(String userId, String userName, String imagePath, byte[] featureData, long registerTime) {
        this.userId = userId;
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(faceId, userId, registerTime, userName, imagePath);
